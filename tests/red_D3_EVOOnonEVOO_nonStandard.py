...
columnas = ['TIPO L-noL','RIP Height','CATEGORÍA']
datos = datos.drop(columnas, axis = 1)

X = datos.drop('TIPO Ex-noEx', axis = 1)
y = datos['TIPO Ex-noEx']
...
(pd.DataFrame.from_dict(data=res, orient='index')
   .to_csv('dict_file_f4_EVOOnonEVOO_NonStandard.csv', header=False))
